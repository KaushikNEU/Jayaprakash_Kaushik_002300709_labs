...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    public void refreshTable() {
        ...
        for (Product p : supplier.getProductCatalog().getProductcatalog()) {
            Object row[] = new Object[4]; // Change array size to 4
            row[0] = p; // Product Name or Object
            row[1] = p.getModelNumber(); // Product ID or Model Number
            row[2] = p.getPrice(); // Price
            row[3] = p.getAvail(); // Availability
            model.addRow(row);
        }
    }
